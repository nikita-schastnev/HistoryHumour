...
public class AncientRomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ancient_rome);
        ...
        new FirebaseDatabaseHelper().readAncientRome(new FirebaseDatabaseHelper.DataStatus() {
            @Override
            public void DataIsLoaded(List<Post> posts, List<String> keys) {
                new RecyclerViewConfig().setConfig(mRecyclerView, AncientRomeActivity.this,
                        posts, keys);
