...
public class MiddleAgesRusActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_middle_ages_rus);
        ...
        new FirebaseDatabaseHelper().readMiddleAgesRus(new FirebaseDatabaseHelper.DataStatus() {
            @Override
            public void DataIsLoaded(List<Post> posts, List<String> keys) {
                new RecyclerViewConfig().setConfig(mRecyclerView, MiddleAgesRusActivity.this,
                        posts, keys);
