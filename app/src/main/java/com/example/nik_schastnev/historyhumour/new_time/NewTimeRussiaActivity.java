...
public class NewTimeRussiaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_time_russia);
        ...
        new FirebaseDatabaseHelper().readNewTimeRussia(new FirebaseDatabaseHelper.DataStatus() {
            @Override
            public void DataIsLoaded(List<Post> posts, List<String> keys) {
                new RecyclerViewConfig().setConfig(mRecyclerView, NewTimeRussiaActivity.this,
                        posts, keys);
