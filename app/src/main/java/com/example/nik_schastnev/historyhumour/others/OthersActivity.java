package com.example.nik_schastnev.historyhumour.others;
...
public class OthersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRecyclerView = (RecyclerView) findViewById(R.id.recyclerview_others);
        mProgressCircle = (ProgressBar) findViewById(R.id.progress_circle);

        new FirebaseDatabaseHelper().readOthers(new FirebaseDatabaseHelper.DataStatus() {
            @Override
            public void DataIsLoaded(List<Post> posts, List<String> keys) {
                new RecyclerViewConfig().setConfig(mRecyclerView, OthersActivity.this,
                        posts, keys);
