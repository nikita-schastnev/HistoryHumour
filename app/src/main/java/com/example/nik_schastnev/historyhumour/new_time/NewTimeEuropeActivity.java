...
public class NewTimeEuropeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_time_europe);
        ...
        new FirebaseDatabaseHelper().readNewTimeEurope(new FirebaseDatabaseHelper.DataStatus() {
            @Override
            public void DataIsLoaded(List<Post> posts, List<String> keys) {
                new RecyclerViewConfig().setConfig(mRecyclerView, NewTimeEuropeActivity.this,
                        posts, keys);
