...
public class MiddleAgesAsiaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_middle_ages_asia);
        ...
        new FirebaseDatabaseHelper().readMiddleAgesAsia(new FirebaseDatabaseHelper.DataStatus() {
            @Override
            public void DataIsLoaded(List<Post> posts, List<String> keys) {
                new RecyclerViewConfig().setConfig(mRecyclerView, MiddleAgesAsiaActivity.this,
                        posts, keys);
